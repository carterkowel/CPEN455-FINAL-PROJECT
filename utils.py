...
def discretized_mix_logistic_loss(x, l, comp_indvid_loss=False):
    ...
    return -torch.sum(log_sum_exp(log_probs), dim=[1,2]) if comp_indvid_loss else -torch.sum(log_sum_exp(log_probs)) 
